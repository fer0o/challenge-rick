...
const NewPayment = () => {
  return (
    <div>
      <div className=' border-2 drop-shadow-md rounded mx-8 mb-7 mt-8 p-2 bg-white text-black w-80 h-auto lg:w-full lg:h-auto lg:m-1 lg:p-4 lg:mx-96 lg:space-y-4 space-y-1 '>
